...
<template>
    ...
    <!-- Scrollable content (Framed Background Card) -->
    <div ref="scrollableSectionRef" class="w-full relative p-[3dvw] bg-white">
        <div class="h-full w-full relative rounded-4xl overflow-hidden shadow-sm">
